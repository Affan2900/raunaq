          ...
          child: Column(
            ...
            children: [
              Container(padding: const EdgeInsets.all(16), decoration: const BoxDecoration(color: Colors.white, shape: BoxShape.circle),
                  child: const Icon(Icons.calendar_today_outlined, color: primaryColor, size: 60)),
              const SizedBox(height: 24),
              const Text('Raunaq', style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.w900, fontStyle: FontStyle.italic, letterSpacing: 2)),
              const SizedBox(height: 12),
              const Text('Plan your dream event with ease', style: TextStyle(color: Colors.black87, fontSize: 16, fontWeight: FontWeight.w500)),
            ],
          ),
        ),
      ),
